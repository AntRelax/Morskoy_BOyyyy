...
namespace CSharp_Shell
{
...

    {
        public static void Main()
        {
            ...
            for (var i = 0; i < 10; i++) Console.Clear();
            Console.WriteLine(pField[1, 1]);
            Console.ReadLine();
            for (var i = 0; i < 10; i++)
            {
                for (var j = 0; j < 10; j++) Console.Write(pField[i, j]);
            ...
            bb:
            Console.WriteLine("You come to bb!");
            var bField = new string[10, 10];
            fld.Give(ref bField);
            prd = 1;
            one = 4;
            two = 3;
            ...
            if (fld.Field_check(pField)) Console.WriteLine("Противник уничтожил все твои корабли!\nТы проиграл!");
